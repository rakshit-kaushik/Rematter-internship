...
# Test some sample material group names
test_cases = [
    ...
    ("Auto Parts", "Autos"),
    ("Metal Alloys", "Alloys"),
    ("Random Material", "Other"),
    ("Aluminum Foil", "Aluminum"),
    ("Copper Tubing", "Copper"),
    ("Steel Plates", "Steel"),
]

print("Testing confidence scores for sample material groups:")
print("=" * 60)

for material_name, target_group in test_cases:
    confidence = calculate_ensemble_confidence(material_name, target_group)
    print(f"{material_name:20} -> {target_group:12} | Confidence: {confidence:.3f}")
